...
import { fetchSentenciasAprobadas } from "../../redux/slices/expedienteSlice";
...
const breadcrumbLinks = [
    ...
    { label: "Sentencias aprobadas", path: "/sentencias" },
];
...
const SentenciasPage = () => {
    ...
    useEffect(() => {
        dispatch(fetchSentenciasAprobadas());
    }, [dispatch]);
    ...
    return (
        <Layout>
            <BreadCrumb links={breadcrumbLinks} title="Sentencias Aprobadas" />
            <section className="max-w-screen-xl mx-auto" id="sentencias">
                <div className="mt-8 mb-8">
                    <Subtitle title="Listado de las Sentencias Aprobadas" />
                    <ul className="list-disc list-inside text-gray-700 mt-4">
                        <li>A continuación, se presenta un listado de todas las sentencias que han sido aprobadas.</li>
