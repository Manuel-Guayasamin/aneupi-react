...
const DshPostulaTrabajoLibre = () => {
  ...
  return (
    <DshContainer title="Postulaciones Libres a Trabajos">
              ...
              registrosTrabajoOrden.map((postulante, index) => (
                ...
                <td className='px-6 py-4 whitespace-nowrap'>{postulante.telefono}</td> */}
                  ...
                  {/* <td className="px-6 py-4 whitespace-nowrap">
                    {" "}
                    {new Date(
                      new Date(postulante.createdAt).getTime() +
                      24 * 60 * 60 * 1000
...
export default DshPostulaTrabajoLibre;
